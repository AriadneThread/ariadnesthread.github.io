...
它用getContext() 方法获取一个用于在画布上绘图的环境。目前为止html5只支持2d。
...
![]({{ site.baseurl }}/assets/post/coor.jpg)
...
![]({{ site.baseurl }}/assets/post/arc.jpg)
...
![]({{ site.baseurl }}/assets/post/arcto.jpg)
